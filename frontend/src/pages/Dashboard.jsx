        ...
        <div>
            ...
            {kpis && (
                <div className="kpi-grid">
                    <KPICard icon="fa-solid fa-truck-moving" label="Active Fleet" value={kpis.activeFleet} sub={`of ${kpis.totalVehicles} vehicles`} />
                    <KPICard icon="fa-solid fa-wrench" label="In Shop" value={kpis.maintenanceAlerts} sub="Maintenance alerts" />
                    <KPICard icon="fa-solid fa-chart-line" label="Utilization Rate" value={`${kpis.utilizationRate}%`} sub="Fleet assigned" />
                    <KPICard icon="fa-solid fa-box" label="Pending Cargo" value={kpis.pendingCargo} sub="Awaiting dispatch" />
                    <KPICard icon="fa-solid fa-indian-rupee-sign" label="Total Op. Cost" value={`₹${kpis.totalOperationalCost?.toLocaleString()}`} sub="Fuel + Maintenance" />
                    <KPICard icon="fa-solid fa-triangle-exclamation" label="Expired Licenses" value={kpis.expiredDrivers} sub="Drivers blocked" />
                </div>
            )}
