        ...
        <div>
            ...
            {dashboard && (
                <div className="kpi-grid">
                    <div className="kpi-card"><div className="kpi-icon">💰</div><div className="kpi-body"><div className="kpi-value">₹{dashboard.totalFuelCost?.toLocaleString()}</div><div className="kpi-label">Total Fuel Cost</div></div></div>
                    <div className="kpi-card"><div className="kpi-icon">🔧</div><div className="kpi-body"><div className="kpi-value">₹{dashboard.totalMaintCost?.toLocaleString()}</div><div className="kpi-label">Total Maint. Cost</div></div></div>
                    <div className="kpi-card"><div className="kpi-icon">📦</div><div className="kpi-body"><div className="kpi-value">{dashboard.completedTrips}</div><div className="kpi-label">Completed Trips</div></div></div>
                    <div className="kpi-card"><div className="kpi-icon">📈</div><div className="kpi-body"><div className="kpi-value">{dashboard.utilizationRate}%</div><div className="kpi-label">Utilization Rate</div></div></div>
                </div>
            )}
